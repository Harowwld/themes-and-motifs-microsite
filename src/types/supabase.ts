    ...
    Tables: {
      ...
      "staging table": {
        Row: {
          ...
          "Authorized Representative - First Name": string | null
          "Authorized Representative - Last Name": string | null
          "Brand Count: 754": number
          business_name: string | null
          Category: string | null
          "Contact Person for the Exhibit - First Name": string | null
          "Contact Person for the Exhibit - Last Name": string | null
          contact_email: string | null
          contact_phone: string | null
          "Designation / Position": string | null
          "Designation / Position_1": string | null
          "Facebook Messenger": string | null
          "Facebook Messenger_1": string | null
          "Facebook Page": string | null
          "Instagram Account": string | null
          location_text: string | null
          Logo: string | null
          "Mobile Number": string | null
          "Number of Years in Business": string | null
          slug: string | null
          "Tax Identification Number": string | null
          Viber: string | null
          Viber_1: string | null
