...
export default function ImageCropperModal({
  ...
  useEffect(() => {
    ...
    const onWheel = (e: WheelEvent) => {
      ...
      const step = 0.08;
      setZoom((z) => clamp(z + (delta > 0 ? -step : step), 1, 3));
    };
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="w-full max-w-2xl rounded-[6px] border border-black/20 bg-white shadow-xl overflow-hidden">
          <div className="px-5 py-4 border-b border-black/10">
            <div className="text-[14px] font-semibold text-[#2c2c2c]">Adjust photo</div>
          ...
          <div className="p-5 grid gap-4">
            <div className="flex justify-center">
              <div
                ref={viewportRef}
                className="relative w-full max-w-[360px] h-[240px] rounded-[6px] border border-black/20 bg-[#f3f4f6] overflow-hidden cursor-grab active:cursor-grabbing"
              >
                <img
                  src={imageUrl}
                  alt=""
