export default function SiteFooter() {
  return (
    <footer className="inset-x-0 border-t border-gray-100 bg-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-4 sm:py-5 flex flex-col sm:flex-row items-center sm:items-center justify-between gap-2 sm:gap-3">
