...
export default function VendorSignupLinkPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      const redirectTo = `${window.location.origin}/vendor/signup`;
    ...
    >
      <div className="mx-auto w-full max-w-3xl px-5 sm:px-8 py-12">
        <div className="rounded-[3px] border border-black/10 bg-white shadow-sm overflow-hidden">
          <div className="p-7">
            <div className="text-[18px] font-semibold tracking-[-0.01em] text-[#2c2c2c]">Vendor sign up</div>
