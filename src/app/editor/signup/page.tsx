    ...
    >
      <div className="mx-auto w-full max-w-3xl px-5 sm:px-8 py-12">
        <div className="rounded-[3px] border border-black/10 bg-white shadow-sm overflow-hidden">
          <div className="p-7">
            <div className="text-[18px] font-semibold tracking-[-0.01em] text-[#2c2c2c]">Editor sign up</div>
            ...
            {sentTo ? (
              <div className="mt-4 rounded-[3px] border border-black/10 bg-[#fcfbf9] px-4 py-3 text-[13px] text-black/70">
                ...
                Check your email and click the link to sign up. An admin will grant you access after signup.
              </div>
            ) : null}
            ...
            <form onSubmit={onSubmit} className="mt-6 grid gap-4">
              ...
              <a className="text-[12px] font-semibold text-[#6e4f33] hover:underline" href="/editor/signin">
