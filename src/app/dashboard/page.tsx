              ...
              <div className="flex items-center gap-2">
                ...
                {isPremium ? (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gradient-to-r from-[#bca374]/25 to-[#a68b6a]/15 text-[#a68b6a] text-[10px] font-black uppercase tracking-wider border border-[#bca374]/30 shadow-sm animate-pulse hover:brightness-95 cursor-pointer transition-all"
                      ...
                      return (
                        <div className="relative min-h-[450px] flex items-center justify-center rounded-2xl overflow-hidden border border-black/[0.04] bg-[#fafafa]/50 p-6 sm:p-10">
                          ...
                          <div className="relative z-10 w-full max-w-md p-8 rounded-2xl border border-[#bca374]/30 bg-white/95 backdrop-blur-md shadow-[0_20px_50px_rgba(188,163,116,0.12)] text-center flex flex-col items-center">
                            ...
                            <button
                              onClick={handleUpgrade}
                              className="w-full py-3 px-6 bg-gradient-to-r from-[#bca374] to-[#a68b6a] text-white text-[13px] font-bold uppercase tracking-wider rounded-xl shadow-[0_4px_15px_rgba(166,139,106,0.2)] hover:shadow-[0_6px_20px_rgba(166,139,106,0.3)] transition-all duration-300 hover:-translate-y-0.5 cursor-pointer"
                            >
